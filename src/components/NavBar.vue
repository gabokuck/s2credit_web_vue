<template>
    ...
    <div class="bg-white opacity-100 md:opacity-80 fixed  w-full z-10">
        <div class="flex px-2 md:px-18 xl:px-64">
            ...
            <div class="flex h-12 w-full bg-transparent m-2 md:items-center pl-2 lg:h-20 lg:w-60 lg:justify-center">
                    <img class="m-auto h-10 lg:h-14" src="../assets/s2credit_logo.svg" alt="logo s2credit">
            </div>
            <div class="flex md:hidden h-12 w-20 bg-co m-2">
                <p class="m-auto"></p>
            </div>
